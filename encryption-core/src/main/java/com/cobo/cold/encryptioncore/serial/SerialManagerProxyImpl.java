...
package com.cobo.cold.encryptioncore.serial;
...
import com.cobo.cold.encryptioncore.interfaces.SerialPortProxy;
...
public class SerialManagerProxyImpl implements SerialManagerProxy {
    ...
    private SerialManagerProxyImpl(@NonNull SerialManager proxy, Context context, int portSpeed) {
        ...
        wakeLock = Objects.requireNonNull(pm).newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Cobo:encryption");
        mProxy = proxy;
