...
public class ProposeBounty extends Pallet<ProposeBountyParameter> {
    public ProposeBounty(Network network, int code) {
        super("treasury.proposeBounty", network, code);
    }

    @Override
    public ProposeBountyParameter read(ScaleCodecReader scr) {
        return new ProposeBountyParameter(name, network, code, scr);
    }
}
