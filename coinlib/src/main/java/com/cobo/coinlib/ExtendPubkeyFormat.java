...
public enum ExtendPubkeyFormat {
    ...
    // mainnet
    xpub(0x0488b21e, "P2PKH or P2SH_P2WSH"),
    ypub(0x049d7cb2, "P2WPKH in P2SH_P2WSH"),
    zpub(0x04b24746, "P2WPKH"),
    Ypub(0x0295b43f, "Multi-signature P2WSH in P2SH_P2WSH"),
    Zpub(0x02aa7ed3, "Multi-signature P2WSH"),
    //testnet
    tpub(0x043587cf, "P2PKH or P2SH_P2WSH"),
    upub(0x044a5262, "P2WPKH in P2SH_P2WSH"),
    vpub(0x045f1cf6, "P2WPKH"),
    Upub(0x024289ef, "Multi-signature P2WSH in P2SH_P2WSH"),
