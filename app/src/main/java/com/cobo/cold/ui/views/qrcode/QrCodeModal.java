...
import com.cobo.cold.databinding.SwitchQrCapacityBottomSheetBinding;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class QrCodeModal extends DialogFragment implements SplitCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        multipart = getArguments().getBoolean("multipart");

        if (!multipart) {
            modalBinding.qrcodeLayout.qrcode.disableMultipart();
        }
        modalBinding.qrcodeLayout.qrcode.setSplitCallback(this);
    ...
    private void refreshCheckedStatus(View view) {
        for (DynamicQrCodeView.QrCapacity capacity : DynamicQrCodeView.QrCapacity.values()) {
            view.findViewWithTag(String.valueOf(capacity.capacity)).setVisibility(View.GONE);
        }
        view.findViewWithTag(String.valueOf(modalBinding.qrcodeLayout.qrcode.qrCapacity.capacity)).setVisibility(View.VISIBLE);
    }
    ...
    public void onSplit(int i) {
        getActivity().runOnUiThread(this::setupController);
    }
}
