...
import com.cobo.cold.fingerprint.EnrollListener;
import com.cobo.cold.fingerprint.FingerprintKit;
import com.cobo.cold.fingerprint.RemovalListener;
    ...
    private boolean registerPublicKey(KeyStore keyStore) {
        ...
        if (bundle != null && !TextUtils.isEmpty(bundle.getString(PASSWORD))) {
            ...
            boolean result = new RegisterPublicKeyCallable(
                    ...
                    Objects.requireNonNull(getArguments()).getString(PASSWORD)).call();
