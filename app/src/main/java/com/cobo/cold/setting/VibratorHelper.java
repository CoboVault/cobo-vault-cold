...
import static com.cobo.cold.ui.fragment.setting.SystemPreferenceFragment.SETTING_VIBRATOR;
...
public class VibratorHelper {
    ...
    public static void vibrate(@NonNull Context context) {
        if (!Utilities.getPrefs(context).getBoolean(SETTING_VIBRATOR, true)) {
            return;
        }
